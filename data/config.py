...
'name': 'Leaves_Dataset',
'train_images':'../TrainTestingCOCO/train',
'train_info':'../TrainTestingCOCO/train/annotations.json',
'valid_images': '../TrainTestingCOCO/val',
'valid_info':  '../TrainTestingCOCO/val/annotations.json',
'class_names': ('brick','cementitious_debris','PVC','rebar','wires'),
})
...
yolact_darknet53_leaves_custom_config = yolact_darknet53_config.copy({
